// TODO: Spojit s example19_bar_graph.html
/**
 * @constructor links.Timeline.ItemBar
 ...
 *                                {Number} height
 */
links.Timeline.ItemBar = function (data, options) {
    links.Timeline.Item.call(this, data, options);
};

links.Timeline.ItemBar.prototype = new links.Timeline.Item();
 ...
 * @override
 */
links.Timeline.ItemBar.prototype.reflow = function () {
    var dom = this.dom,
 ...
 * @override
 */
links.Timeline.ItemBar.prototype.select = function () {
    var dom = this.dom;
 ...
 * @override
 */
links.Timeline.ItemBar.prototype.unselect = function () {
    var dom = this.dom;
 ...
 * @override
 */
links.Timeline.ItemBar.prototype.createDOM = function () {
    // background box
 ...
 * @override
 */
links.Timeline.ItemBar.prototype.showDOM = function (container) {
    var dom = this.dom;
    if (!dom) {
        dom = this.createDOM();
    }
 ...
 * @override
 */
links.Timeline.ItemBar.prototype.hideDOM = function () {
    var dom = this.dom;
    if (dom) {
        if (dom.parentNode) {
 ...
 * @override
 */
links.Timeline.ItemBar.prototype.updateDOM = function () {
    var divBox = this.dom;
    if (divBox) {
 ...
 * @override
 */
links.Timeline.ItemBar.prototype.updatePosition = function (timeline) {
    var dom = this.dom;
    if (dom) {
 ...
 * @override
 */
links.Timeline.ItemBar.prototype.isVisible = function (start, end) {
    if (this.cluster) {
        return false;
    }
 ...
 * @override
 */
links.Timeline.ItemBar.prototype.setPosition = function (left, right) {
    var dom = this.dom;
 ...
 * @override
 */
links.Timeline.ItemBar.prototype.getLeft = function (timeline) {
 ...
 * @override
 */
links.Timeline.ItemBar.prototype.getRight = function (timeline) {
    var boxAlign = (timeline.options.box && timeline.options.box.align) ?
        timeline.options.box.align : undefined;

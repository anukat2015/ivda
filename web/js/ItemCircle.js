...
links.Timeline.ItemCircle.prototype.showDOM = function (container) {
    ...
    if (!dom) {
        dom = this.createDOM();
        dom.dot.style.width = radius;
        dom.dot.style.height = radius;
    }
...
links.Timeline.ItemCircle.prototype.updateDOM = function () {
    if (this.dom) {
        ...
        // update classes
        divBox.className = "timeline-event-circle-container";
        divDot.className  = "timeline-event timeline-event-circle ui-widget ui-state-default";

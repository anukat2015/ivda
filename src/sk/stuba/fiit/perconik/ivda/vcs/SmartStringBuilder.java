...
//	public final SmartStringBuilder list(Iterator<?> values)
	...
	public final SmartStringBuilder splitList(Object value, Splitter.MapSplitter splitter, MapJoiner joiner)
	{
		return this.splitList(this.toString(value), splitter, joiner);
	}

	public final SmartStringBuilder splitList(String value, Splitter.MapSplitter splitter, MapJoiner joiner)
	{
		return this.splitList((CharSequence) value, splitter, joiner);
	}

	public final SmartStringBuilder splitList(CharSequence value, Splitter.MapSplitter splitter, MapJoiner joiner)
	{
